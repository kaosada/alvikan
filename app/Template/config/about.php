...
<div class="listing">
    <ul>
        <li>
            <?= t('Official website:') ?>
            <a href="/" target="_blank" rel="noreferer">WP GROUP`</a>
        </li>
        <li>
            <?= t('Author:') ?>
            <strong>Frédéric Guillot</strong>
        </li>
	<li>
            <?= t('Development:') ?>
            <strong>Alvi Nuari</strong> (<a href="https://github.com/kaosada" target="_blank"><?= t('contributors') ?></a>)
        </li>
        <li>
            <?= t('License:') ?>
            <strong>MIT</strong>
